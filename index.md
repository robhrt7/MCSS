...
*Всегда будем рады ответить на ваши вопросы в разделе [Issues на Github](https://github.com/robhrt7/MCSS/issues) или в комментариях на страницах сайта проекта.*
...
**Более комплексный пример использования методологии в действии, с видео записью процесса разработки можно найти [тут](https://github.com/robhrt7/markup-process).**
