...
* Твиттер автора методологии [@operatino](http://twitter.com/operatino)

## Будущее MCSS
* Видео запись презентации MCSS c [Web Standards Days](http://webstandardsdays.ru)
* Наборы живых примеров, и взаимодействие методологии с популярными фреймворками как [Bootstrap](http://twitter.github.com/bootstrap/)
